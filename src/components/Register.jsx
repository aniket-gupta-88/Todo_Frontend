    ...
    <div className="row justify-content-md-center mt-4">
        <div className="col-lg-5 card border-primary mb-3">
            ...
            <div className="form-group">
                    ...
                    {
                      errors?.name && <small id="nameHelp" className="form-text text-danger">
                ...
                <div className="form-group">
                 ...
                 {
                  errors?.username && <small id="usernameHelp" className="form-text text-danger">
                  {errors.username.msg}
                  </small>
                 }
                </div>
                ...
                {
                errors?.password && <small id="passwordHelp" className="form-text text-danger">
                {errors.password.msg}
              </small>
              }
                </div>
